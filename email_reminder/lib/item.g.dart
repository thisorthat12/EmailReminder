...
void _itemSerialize(
  ...
  writer.writeDateTime(offsets[0], object.boughtTime);
...
Item _itemDeserialize(
  ...
  final object = Item(
    boughtTime: reader.readDateTime(offsets[0]),
    expiryTime: reader.readDateTime(offsets[1]),
...
extension ItemQueryFilter on QueryBuilder<Item, Item, QFilterCondition> {
  QueryBuilder<Item, Item, QAfterFilterCondition> boughtTimeEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'boughtTime',
        value: value,
      ));
    });
  }

  QueryBuilder<Item, Item, QAfterFilterCondition> boughtTimeGreaterThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> boughtTimeLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> boughtTimeBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> expiryTimeEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> expiryTimeGreaterThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> expiryTimeLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> expiryTimeBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension ItemQuerySortBy on QueryBuilder<Item, Item, QSortBy> {
  QueryBuilder<Item, Item, QAfterSortBy> sortByBoughtTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'boughtTime', Sort.asc);
    });
  }

  QueryBuilder<Item, Item, QAfterSortBy> sortByBoughtTimeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'boughtTime', Sort.desc);
    });
  }

  QueryBuilder<Item, Item, QAfterSortBy> sortByExpiryTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'expiryTime', Sort.asc);
    });
  }

  QueryBuilder<Item, Item, QAfterSortBy> sortByExpiryTimeDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ItemQuerySortThenBy on QueryBuilder<Item, Item, QSortThenBy> {
  QueryBuilder<Item, Item, QAfterSortBy> thenByBoughtTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'boughtTime', Sort.asc);
    });
  }

  QueryBuilder<Item, Item, QAfterSortBy> thenByBoughtTimeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'boughtTime', Sort.desc);
    });
  }

  QueryBuilder<Item, Item, QAfterSortBy> thenByExpiryTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'expiryTime', Sort.asc);
    });
  }

  QueryBuilder<Item, Item, QAfterSortBy> thenByExpiryTimeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'expiryTime', Sort.desc);
    });
  }
...
extension ItemQueryWhereDistinct on QueryBuilder<Item, Item, QDistinct> {
  QueryBuilder<Item, Item, QDistinct> distinctByBoughtTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'boughtTime');
    });
  }

  QueryBuilder<Item, Item, QDistinct> distinctByExpiryTime() {
    return QueryBuilder.apply(this, (query) {
...
extension ItemQueryProperty on QueryBuilder<Item, Item, QQueryProperty> {
  ...
  QueryBuilder<Item, DateTime, QQueryOperations> boughtTimeProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'boughtTime');
    });
  }

  QueryBuilder<Item, DateTime, QQueryOperations> expiryTimeProperty() {
    return QueryBuilder.apply(this, (query) {
